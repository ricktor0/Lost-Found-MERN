...
import claimRequest from "../controllers/Items/claimRequest.js";
import acceptClaim from "../controllers/Items/acceptClaim.js";
import declineClaim from "../controllers/Items/declineClaim.js";
const router = express.Router();

// Claim request endpoint

// Accept/Decline claim endpoints
router.post("/claim-request/accept", validateJWT, acceptClaim);
router.post("/claim-request/decline", validateJWT, declineClaim);
router.post("/claim-request", validateJWT, claimRequest);
